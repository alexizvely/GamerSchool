  ...
  function fn_siteLoader() {
    ...
    $.Velocity
      .RegisterEffect('transition.bfcSlideDownIn_60', {
        defaultDuration: 800,
        calls: [
          [ { translateZ: 0, translateY: [0, '60px'], opacity: [ 0, 1 ] } ]
        ]
      })
      ...
      .RegisterEffect('transition.bfcSlideUpIn_15', {
        defaultDuration: 800,
        calls: [
          [ { translateZ: 0, translateY: [0, '15px'], opacity: [ 0, 1 ] } ]
        ]
      })
...
=================================================*/
  ...
  function fn_slider() {
    ...
    for (var i = 1; i <= _imgAmount; i++) {
        $('#img').append('<img src="/Content/backgrounds/public/cloud-' + (i < 10 ? '0' + i : i) + '.png">');
    }
