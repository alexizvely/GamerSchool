...
color
==============================================================================*/
var _mainColor = 'light'; // ['light', 'dark']
...
var _ytMute = true; // mute on start
var _ytRemoveVolume = true; // remove volume icon, if _ytMute = false will still have volume
...
_effect = 1
  - cloud
=================================================*/
var _cloudOpacity = 1; // [0.1 to 1] - cloud opacity
var _cloudPosition = 1; // 1 = default, 2 = bottom
