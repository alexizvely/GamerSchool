    ...
    public class StrategyController : BaseController
    {
        ...
        public ActionResult Index(int id = 1)
        {
            ...
            var allItemsCount = this.tutorials
                .GetAll()
                .Count(x => x.Type == TutorialType.Strategy);
        ...
        public ActionResult Create(TutorialInputViewModel model)
        {
            if (model != null && this.ModelState.IsValid)
            {
                ...
                newArticle.Type = TutorialType.Strategy;
                ...
                // TODO: Fix Redirect
                return this.RedirectToAction("Details", "Strategy", new { area = "", id = result });
            }
        ...
        public ActionResult Edit(TutorialInputViewModel model)
        {
            if (model != null && this.ModelState.IsValid)
            {
                ...
                // TODO: Fix Redirect
                return this.RedirectToAction("Details", "Strategy", new { area = "", id = model.Id });
            }
        ...
        public ActionResult Destroy(int id)
        {
            ...
            // TODD: Fix Redirects
            return this.RedirectToAction("Index", "Strategy", new { area = "Users", id = 1 });
        }
    }
}